namespace War3App.MapAdapter.Constants
{
    ...
    {
        public const string ContinueWithoutGameFiles = "You have not entered the path to the game files for the target patch. Do you want to proceed without configuring the game files path? Some file types cannot be adapted without these files.";
